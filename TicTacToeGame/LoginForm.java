...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void jButton_LOGINActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LOGINActionPerformed
        ...
        else if(password.equals(""))
        {
            ...
            int canYouLogin = proxy.login(username, password);
            
            switch (canYouLogin) {
                case -1:   EnterUID euid = new EnterUID(username);
                    euid.setVisible(true);
                    euid.pack();
                    euid.setLocationRelativeTo(null);
                    euid.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                    this.dispose();
                    break;
                case 0:
                    JOptionPane.showMessageDialog(null, "Unsuccessful Login Attempt!");
                    break;
                default:  JOptionPane.showMessageDialog(null, "Successful Login Attempt!");
                    break;
